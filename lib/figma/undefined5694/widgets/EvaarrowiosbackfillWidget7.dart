...
import 'package:flutterapp/figma/undefined5694/widgets/VectorWidget7.dart';

/* Frame eva:arrow-ios-back-fill
    Autogenerated by FlutLab FTF Generator
  */
class EvaarrowiosbackfillWidget7 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/FirstpageWidget'),
      child: Container(
        width: 24.0,
        height: 24.0,
        child: ClipRRect(
